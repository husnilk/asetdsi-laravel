...
class InventoryItemPJController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('pages.p_j.stock.index', compact('indexItem', 'selected', 'lokasi', 'pj'));
    }
    ...
    public function item()
    {
        ...
        return view('pages.p_j.newbarang.item', compact('pj', 'pjsmap'));
    }
    ...
    public function list($id)
    {
        ...
        return view('pages.p_j.newbarang.list', compact('indexItem', 'selected'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('pj-aset/barang')->with('success', 'stock berhasil ditambahkan');
    }
    ...
    public function stock($id)
    {
        ...
        return view('pages.p_j.stock.stock', compact('barang', 'item', 'lokasi', 'pj', 'selected'));
    }
    /**
