...
class BuildingPJController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pages.p_j.bangunan.bangunan', compact('indexBangunan'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('pages.p_j.bangunan.bangunan', compact('bangunan'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.p_j.bangunan.create', compact('bangunan', 'aset', 'pj'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('pj-aset/bangunan')->with('success', 'Bangunan berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.p_j.bangunan.edit', compact('indexBangunan', 'aset', 'pj'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('pj-aset/bangunan')->with('success', 'Bangunan berhasil diedit!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('pj-aset/bangunan')->with('success', 'Bangunan berhasil dihapus');
    }
}
