...
class ProfileController extends Controller
{
    ...
    return view('pages.profile.profile', compact('indexAdmin','indexPJ','indexMahasiswa'));
    }
    ...
    return view('pages.profile.edit', compact('indexAdmin'));
    }
    ...
    return redirect('profile')->with('success', 'Admin berhasil diedit!');
    }
