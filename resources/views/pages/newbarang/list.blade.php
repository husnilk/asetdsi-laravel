...
@section('title') Daftar Aset Barang @endsection
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end m-3">
                    <button type="button" class="btn btn-round ml-auto transisi" style="line-height:1 !important" data-toggle="modal">
                        ...
                        <i class=" mdi mdi-printer " style="color: white;" data-bs-toggle="tooltip" title="print"><a href="{{route('newbarang.print',[$s->pic_id])}}" class="button" style="color:white !important; text-decoration:none; font-size:0.9rem;" class=" mdi mdi-plus">
                    ...
                    <table id="table" class="table table-bordered table-hover align-items-center table-flush pt-2 ">
                        <thead class="thead-light">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="ukuran fw-bold" style="width: 5%;">Status</th>
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;">
                                    <span class="name mb-0 text-md ukuran arai " style="display: block;padding-top:10px;">{{$i->kondisi}}</span>
                                </td>
