...
@section('title') Daftar Penanggung Jawab AsetDSI @endsection
...
@slot('li_3') Tambah Penanggung Jawab @endslot
  ...
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Tambah PJ</h4>

      </div>


      <form action="{{route('pj.store')}}" autocomplete="off" method="post" id="add_form" enctype="multipart/form-data">
            ...
            <div class="container mb-3">
              <div class="row mb-3">
                <div class="col">
                  ...
                  <input id="pic_name" name="pic_name" type="text" class="form-control" placeholder="masukkan nama PJ" required>
                </div>
