  ...
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Tambah Mahasiswa</h4>

      </div>


      <form action="{{route('mahasiswa.store')}}" autocomplete="off" method="post" id="add_form" enctype="multipart/form-data">
          ...
          <div class="col-12 col-md-12">
            ...
            <div class="container">
              <div class="row mb-3">
                <div class="col">
                  <label>NIM</label>
                  <input id="nim" name="nim" type="text" class="form-control" placeholder="masukkan nim" required>
                </div>
