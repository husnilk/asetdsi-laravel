...
@section('title') Daftar Lokasi Aset @endsection
...
@slot('li_3') Daftar Lokasi Aset @endslot
  ...
  <div class="col-md-12 grid-margin">
    <div class="card shadow-sm bg-body rounded">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Daftar List Lokasi Aset</h4>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-end m-3">
          <button type="button" class="btn btn-round ml-auto transisi" style="line-height:1 !important" data-toggle="modal">
            ...
            <a href="{{route('lokasi.create')}}" class="button" style="color:black !important; text-decoration:none; font-size:0.9rem;" class=" mdi mdi-plus">
          ...
          <table id="table" class="table table-bordered table-hover align-items-center table-flush pt-2 ">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="ukuran">Nama Lokasi Aset</th>
            ...
            <tbody class="list">
              ...
              <tr>
                ...
                <td class="text-left d-flex justify-content-center">
                  <a class="btn btn-sm btn-neutral ukuran-icon" href="{{route('lokasi.edit',[$i->id])}}"><i class=" mdi mdi-pencil " style="color: green;" aria-hidden="true"  data-bs-toggle="tooltip" title="edit lokasi"></i></a>
                  <a class="btn btn-sm btn-neutral brgdeletebtn ukuran-icon" href="{{route('lokasi.destroy',[$i->id])}}" onclick="return confirm('Yakin Ingin Menghapus?')"><i class=" mdi mdi-delete " style="color: red;" aria-hidden="true"  data-bs-toggle="tooltip" title="hapus lokasi"></i></a>
                </td>
