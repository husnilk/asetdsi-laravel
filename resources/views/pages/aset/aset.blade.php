  ...
  <div class="col-md-12 grid-margin">
    <div class="card shadow-sm bg-body rounded">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset;">Daftar List Aset</h4>
          ...
          <table id="table" class="table align-items-center table-flush pt-2">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="ukuran">Jenis Aset</th>
            ...
            <tbody class="list">
              ...
              <tr>
                ...
                <td>
                  <span class="name mb-0 text-md ukuran arai" style="display: block;">{{$i->nama_jenis}}</span>
                </td>
                <td>
                  <span class="name mb-0 text-md ukuran">{{$i->kode_aset}}</span>
                </td>
                <td>
                  <span class="name mb-0 text-md ukuran">{{$i->nama_barang}}</span>
                </td>
