...
@section('title') Edit Profile AsetDSI @endsection
  ...
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Edit Profile</h4>

      </div>


      @foreach($indexPJ as $i)
      <form action="{{route('pj-aset.profile.update')}}" method="post" id="add_form" enctype="multipart/form-data">
          ...
          <div class="col-12 col-md-12">
            ...
            <div class="container">
              <div class="row mb-3">
                ...
                <div class="col">
                  <label>Nama</label>
                  <input id="pic_name" name="pic_name" type="text" class="form-control" placeholder="masukkan nama" value="{{$i->pic_name}}" required>
                </div>
            ...
            <div class="field mt-3" style="display: flex; justify-content: flex-end;">
              <button type="submit" name="tambah" class="btn btn-round transisi" id="add_btn" style="margin-right: 1.5rem !important;">Save</button>
            </div>
