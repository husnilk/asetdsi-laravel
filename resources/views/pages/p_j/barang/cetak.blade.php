    ...
    <table id="table" class="table table-bordered table-hover align-items-center table-flush">
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                @else
                <td style="vertical-align: top; border-top: unset; border-bottom: unset">
                    <span class="name mb-0 text-md ukuran-nama arai fw-bold" style="display: block;"></span>
                </td>
                @endif
                @endif
                @endforeach
                ...
                @else
                <td class="text-center" style="vertical-align: top; border-top: unset; border-bottom: unset">

                    <span class="name mb-0 text-md ukuran" style="display: block;"></span>
