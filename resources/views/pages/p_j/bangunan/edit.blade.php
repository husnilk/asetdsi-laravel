...
@section('title') Edit Bangunan @endsection
...
@slot('li_3') Edit Bangunan @endslot
...
<div class="row mt-2">
  <div class="col-md-12 grid-margin">
    <div class="card">
      ...
      <form action="{{route('pj-aset.bangunan.update',[$i->building_id])}}" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <div class="content m-3 p-1">
          ...
          <div class="form-group form-group-default">
              ...
              <div class="container">
                  <div class="row mb-3">
                    <div class="col">
                      ...
                      <input id="building_name" name="building_name" type="text" class="form-control" value="{{ $i->building_name}}" placeholder="masukkan nama bangunan" required>
                    </div>
            ...
            <div class="field mt-3" style="display: flex; justify-content: flex-end;">
              <button type="submit" name="tambah" class="btn btn-round transisi" id="add_btn">Save</button>
            </div>
