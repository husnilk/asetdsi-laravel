                    ...
                    <table id="table" class="table table-bordered table-hover align-items-center table-flush pt-2 ">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="ukuran" >Harga Satuan</th>
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <button class="btn btn-success btn-sm me-2"><a class="ukuran-icon" href="{{route('pj-aset.peminjaman.acc',[$i->proposal_id])}}" onclick="return confirm('Yakin Ingin Menyetujui?')">
                                            <i class=" mdi mdi-check" aria-hidden="true" style="color: white;"></i></a>

                                    </button>

                                    <button class="btn btn-danger btn-sm"><a class="ukuran-icon" href="{{route('pj-aset.peminjaman.reject',[$i->proposal_id])}}" onclick="return confirm('Yakin Ingin Menolak?')">
