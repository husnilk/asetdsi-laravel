...
@section('title') Edit Jenis Aset @endsection
  ...
  <div class="col-md-12 grid-margin">
    <div class="card">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Edit Jenis Aset</h4>

      </div>

      @foreach($indexJenis as $i)
      <form action="{{route('jenis.update',[$i->type_id])}}" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <div class="content m-3 p-1">
          ...
          <div class="col-12 col-md-12">
            ...
            <div class="form-group form-group-default">
              ...
              <input id="type_name" name="type_name" type="text" class="form-control" placeholder="masukkan nama jenis aset" value="{{$i->type_name}}" required>
            </div>
