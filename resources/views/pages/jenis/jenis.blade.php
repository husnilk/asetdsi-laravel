...
@section('title') Daftar Jenis Aset @endsection
  ...
  <div class="col-md-12 grid-margin">
    <div class="card shadow-sm bg-body rounded">
      <div class="card-header warna-header">
        ...
        <h4 class="card-title" style="margin-bottom: unset; color: #1A4D2E !important;">Daftar List Jenis Aset</h4>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-end m-3">
          <button type="button" class="btn btn-round ml-auto transisi" style="line-height:1 !important" data-toggle="modal">
            ...
            <a href="{{route('jenis.create')}}" class="button" style="color:black !important; text-decoration:none; font-size:0.9rem;" class=" mdi mdi-plus">
          ...
          <table id="table" class="table align-items-center table-flush pt-2">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="ukuran">Nama Jenis Aset</th>
            ...
            <tbody class="list">
              ...
              <tr>
                ...
                <td class="text-left">
                  <a class="btn btn-sm btn-neutral ukuran-icon" href="{{route('jenis.edit',[$i->type_id])}}"><i class=" mdi mdi-pencil " style="color: green;" aria-hidden="true"></i></a>
                  <a class="btn btn-sm btn-neutral brgdeletebtn ukuran-icon" href="{{route('jenis.destroy',[$i->type_id])}}" onclick="return confirm('Yakin Ingin Menghapus?')"><i class=" mdi mdi-delete " style="color: red;" aria-hidden="true"></i></a>
                </td>
